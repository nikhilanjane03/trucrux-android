...
=========================================
Usage:
sudo MACHINE=<imx8mq-trux|imx8mm-trux|imx8mp-trux> sources/meta-trucrux/scripts/trux_mk_yocto_sdcard/trux-create-yocto-sdcard-with-android.sh [options] /dev/sdX
(Change /dev/sdX to your device name)
