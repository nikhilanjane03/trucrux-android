...
#
# Trucrux TRUX-MX8M patches for Android 10.0.0 2.5.0
...
readonly G_EXT_CROSS_COMPILER_LINK="https://developer.arm.com/-/media/Files/downloads/gnu-a/8.3-2019.03/binrel/gcc-arm-8.3-2019.03-x86_64-aarch64-linux-gnu.tar.xz?revision=2e88a73f-d233-4f96-b1f4-d8b36e9bb0b9&hash=C6CE74D7E1189F53EAC2D9DB08AADE29"
readonly BASE_BRANCH_NAME="android-11.0.0_1.0.0"

## git variables get from base script!
readonly _EXTPARAM_BRANCH="android-11.0.0_1.0.0-trux_dev"
